...
var routesConfig = [
    ...
    { path: 'detail/:id/:sdt', component: _contact_detail_contact_detail_component__WEBPACK_IMPORTED_MODULE_2__["ContactDetailComponent"] },
...
var AppRoutingModule = /** @class */ (function () {
    ...
    AppRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forRoot(routesConfig), _angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"]],
            declarations: [
...
module.exports = "\n  <!--<div style=\"text-align:center\">-->\n  <!--<h1>-->\n    <!--Welcome to {{ title }}!-->\n  <!--</h1>-->\n<!--<app-word></app-word>-->\n\n<!--</div>-->\n<!--<li *ngFor=\"let item of collection | paginate: { itemsPerPage: 10, currentPage: p, totalItems: 200 }\">{{item}}</li>-->\n<!--<pagination-controls (pageChange)=\"p = $event\" ></pagination-controls>-->\n<!--<app-struct></app-struct>-->\n<!--<app-person name=\"Ti nguyen\" tuoi=\"18\"></app-person>-->\n<!--<app-person name=\"Teo nguyen\" tuoi=\"18\"></app-person>-->\n<!--<app-parent></app-parent>-->\n  <!--<br>-->\n<!--<app-card><h3 class=\"card-header\">oc cho</h3><h3 class=\"card-body\">oc tom</h3></app-card>-->\n  <!--<p>{{4.5|roundNum:false}}</p>-->\n<!--<app-weather></app-weather>-->\n<!--<app-sign-in></app-sign-in>-->\n<a routerLink=\"/contacts\">Contacts</a>\n<a routerLink=\"/detail\" style=\"margin-left: 10px;\">Detail</a>\n<router-outlet></router-outlet>\n\n"
...
/* harmony import */ var _card_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./card.component */ "./src/app/card.component.ts");
/* harmony import */ var _learn_pipe_learn_pipe_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./learn-pipe/learn-pipe.component */ "./src/app/learn-pipe/learn-pipe.component.ts");
/* harmony import */ var _round_pipe__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./round.pipe */ "./src/app/round.pipe.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _round_pipe__WEBPACK_IMPORTED_MODULE_14__["ExponentialStrengPipe"],
...
var ContactDetailComponent = /** @class */ (function () {
    function ContactDetailComponent(ar) {
        this.ar = ar;
    }
    ContactDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.ar.paramMap.subscribe(function (paramMap) {
            _this.id = paramMap.get('id');
            _this.sdt = paramMap.get('sdt');
        });
    };
...
module.exports = "<div *ngFor=\"let c of contacts\"><a routerLink=\"/detail/{{c.id}}/{{c.phoneNumber}}\">{{c.name}}</a></div>\n"
...
var IpComponent = /** @class */ (function () {
    function IpComponent(ips) {
        this.ips = ips;
    }
    IpComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.ips.getIp().then(function (ip) { return _this.ip = ip; }).catch(function (err) { return console.log(err); });
    };
    IpComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ip_service__WEBPACK_IMPORTED_MODULE_2__["IpService"]])
    ], IpComponent);
    return IpComponent;
}());
...
var IpService = /** @class */ (function () {
    ...
    IpService.prototype.getIp = function () {
        return this.http.get('http://ip.jsontest.com/')
            ...
            .then(function (resJson) { return resJson.ip; }).catch(function (err) { return console.log(err); });
    };
...
module.exports = "<p>\n  list-person works!\n</p>\n<div *ngFor=\"let word of listPerson\" >\n  <app-person [name]=\"word.en\" [tuoi]=\"18\"></app-person>\n</div>\n"
...
var ParentComponent = /** @class */ (function () {
    ...
    ParentComponent.prototype.myEvent = function () {
        this.myChild.value++;
    };
    __decorate([
    ...
    ParentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: "\n  <app-child></app-child>\n  <button (click)=\"myEvent();\">add</button>\n  "
        }),
        __metadata("design:paramtypes", [])
    ], ParentComponent);
...
/*!*******************************!*\
  !*** ./src/app/round.pipe.ts ***!
  \*******************************/
/*! exports provided: ExponentialStrengPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExponentialStrengPipe", function() { return ExponentialStrengPipe; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ExponentialStrengPipe = /** @class */ (function () {
    function ExponentialStrengPipe() {
    }
    ExponentialStrengPipe.prototype.transform = function (value, isUpper) {
        if (isUpper) {
            return Math.ceil(value);
        }
        return Math.floor(value);
    };
    ExponentialStrengPipe = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"])({ name: 'roundNum' })
    ], ExponentialStrengPipe);
    return ExponentialStrengPipe;
}());
...
var SignInComponent = /** @class */ (function () {
    ...
    SignInComponent.prototype.ngOnInit = function () {
        this.formGroup = this.fb.group({
            email: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, gmailValidatior]],
            password: '',
    ...
    SignInComponent.prototype.onSubmit = function () {
        // return this.ss.sendPost(formSignIn.value).then(re =>{console.log(re);this.xx=re;console.log(this.xx);} ).catch(er => console.log(er));
...
module.exports = "<p *ngIf=\"isShow\">\n  struct works!\n</p>\n<button (click)=\"isShow=!isShow\">isShow</button>\n<ul><li *ngFor=\"let i of vuilen\"><p>{{'dem so:' + i}}</p></li></ul>\n<input placeholder=\"english\" [(ngModel)]=\"en\">\n<input placeholder=\"vietnam\" [(ngModel)]=\"vn\">\n<button (click)=\"onclick();\" >xxxxxxxx</button>\n<select [(ngModel)]=\"filter\"><option value=\"all\">Xem tất cả</option><option value=\"daNho\">Xem phần tử đã nhớ</option><option value=\"chuaNho\">Xem phần tử chưa nhớ</option></select>\n<ul><li *ngFor=\"let k of arrWords\"><div *ngIf=\"filter==='all'||(filter==='daNho'&&k.memorized===true)||(filter==='chuaNho'&&k.memorized===false)\"><p [ngStyle]=\"{color:k.memorized ? 'red':'blue'}\">{{k.en}}<p>{{k.vn}}</p><button (click)=\"xoaTu(k.id)\">Xóa</button><button (click)=\"k.memorized=!k.memorized;\">{{k.memorized?'đã thuộc':'chưa thuộc'}}</button></div></li></ul>\n"
...
var StructComponent = /** @class */ (function () {
    function StructComponent() {
        this.isShow = true;
        this.vuilen = [1, 2, 3, 4, 5, 6, 10, 7, 8, 9];
        this.arrWords = [
            { id: 1, en: 'action', vn: 'hành động', memorized: true },
            { id: 2, en: 'actor', vn: 'diễn viên', memorized: false },
            { id: 3, en: 'activity', vn: 'hoạt động', memorized: true },
    ...
    StructComponent.prototype.onclick = function () {
    ...
    StructComponent.prototype.xoaTu = function (id) {
...
module.exports = "<p>{{cityname===''? 'Enter your city name' : (cityname + 'is now' +  temp)}} </p>\n\n<input placeholder=\"Enter your city name\" [(ngModel)] = \"txtCityName\"> <br>\n\n<button (click)=\"getWeather();\">Get weather</button>\n"
...
var WeatherComponent = /** @class */ (function () {
    ...
    WeatherComponent.prototype.getWeather = function () {
        var _this = this;
        this.isLoading = true;
        this.ws.getTemp(this.txtCityName).then(function (temp) { _this.cityname = _this.txtCityName; _this.isLoading = false; _this.temp = temp; })
            .catch(function (err) { alert('Khong tim thay thanh pho!'); _this.isLoading = false; _this.txtCityName = ''; _this.cityname = ''; });
    };
    WeatherComponent.prototype.getMessage = function () {
        if (this.txtCityName === '' || this.isLoading === false) {
            return 'Loadign////////////////////////////////';
        }
...
var WeatherService = /** @class */ (function () {
    ...
    WeatherService.prototype.getTemp = function (cityname) {
        ...
        return this.http.get(url).toPromise().then(function (res) { return res.json(); }).then(function (resJson) { return resJson.main.temp; });
    };
...
module.exports = "<!DOCTYPE html>\r\n<html lang=\"en\">\r\n<head>\r\n    <meta charset=\"UTF-8\">\r\n    <title>Title</title>\r\n</head>\r\n<body>\r\n  <h3>Thi dau di toi oi</h3>\r\n  <input placeholder=\"Enter your name\" [(ngModel)]=\"name\" #txtName>\r\n  <h3>username:{{name}}</h3>\r\n  <code>{{txtName | json}}</code>\r\n<h3 [style.color] = \"name.length %2 === 0  ? 'red' : 'blue'\">anh oi {{name}}</h3>\r\n  <div [class] = \"name.length %2 === 0  ? 'circle' : 'square'\">anh oi {{name}}</div>\r\n  <h3 [ngStyle]=\"name.length %2 === 0  ? oddStyle : evenStyle\">anh oi ng style</h3>\r\n\r\n  <div [ngClass]=\"currrentClass\"></div>\r\n</body>\r\n</html>\r\n"
...
var WordComponent = /** @class */ (function () {
    function WordComponent() {
        ...
        this.name = 'asdadasd';
        this.evenStyle = { color: 'red', fontSize: '150px' };
        this.oddStyle = { color: 'red', fontSize: '50px' };
        this.currrentClass = { square: this.isHightlight, circle: !this.isHightlight };
    }
    WordComponent.prototype.showEvent = function (event) {
        console.log(event);
    };
...
module.exports = __webpack_require__(/*! C:\Users\Trau\.IntelliJIdea2018.1\WorkSpace\AngularTest1\src\main.ts */"./src/main.ts");
